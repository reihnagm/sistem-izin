	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
                ...
                if ($data_cek['keperluan'] == "Pergi") echo "<option value='Pergi' selected>Pergi</option>";
                else echo "<option value='Pergi'>Pergi</option>";
            ?>
					</select>
				</div>
			</div>
		...
		<div class="card-footer">
			...
			<a href="?page=ptg-data-izin" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
<?php
    ...
    if ($query_ubah) {
      ...
      Swal.fire({title: 'Ubah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        ...
        {window.location = 'index.php?page=ptg-data-izin';
        }
      })</script>";
      }else{
      echo "<script>
